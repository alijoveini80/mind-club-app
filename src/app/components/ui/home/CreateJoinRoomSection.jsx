...
export default function CreateJoinRoomSection({ section }) {
  return (
      ...
      <CardHeader className="flex gap-3">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-small text-default-600 text-center">
            {section === "create"
              ? "Try creating a room to play with friends."
              : "Try joining a room to play with friends."}
          </p>
          <div className="flex flex-col items-center gap-2 mt-4">
            <Button
              className="min-w-[70%] sm:min-w-[50%]"
              color={section === "create" ? "primary" : "secondary"}
              variant="flat"
            >
              {section === "create" ? "Create" : "Join"}
            </Button>
          </div>
        </div>
      </CardHeader>
